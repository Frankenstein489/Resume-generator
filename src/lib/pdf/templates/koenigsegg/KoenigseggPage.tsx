// Ported from Reactive Resume (packages/pdf/src/templates/koenigsegg/KoenigseggPage.tsx)
...
type KoenigseggStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	sidebarColumn: Style;
...
type KoenigseggTemplate = {
	colors: TemplateColorRoles;
	styles: KoenigseggStyles;
};

type KoenigseggHeaderProps = {
	styles: KoenigseggStyles;
	colors: TemplateColorRoles;
};

export const KoenigseggPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useKoenigseggTemplate();
...
const Header = ({ styles, colors }: KoenigseggHeaderProps) => {
...
const useKoenigseggTemplate = (): KoenigseggTemplate => {
