// Ported from Reactive Resume (packages/pdf/src/templates/maserati/MaseratiPage.tsx)
...
type MaseratiStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	picture: Style;
	headerTitle: Style;
...
type MaseratiTemplate = {
	colors: TemplateColorRoles;
	styles: MaseratiStyles;
};

type MaseratiHeaderProps = {
	styles: MaseratiStyles;
};

export const MaseratiPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useMaseratiTemplate();
...
const Header = ({ styles }: MaseratiHeaderProps) => {
...
const useMaseratiTemplate = (): MaseratiTemplate => {
