// Ported from Reactive Resume (packages/pdf/src/templates/ferrari/FerrariPage.tsx)
...
type FerrariStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	picture: Style;
	headerTitle: Style;
...
type FerrariTemplate = {
	colors: TemplateColorRoles;
	styles: FerrariStyles;
};

type FerrariHeaderProps = {
	styles: FerrariStyles;
};

const getFerrariSections = ({
	mainSections,
	sidebarSections,
	fullWidth,
}: {
...
export const FerrariPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { styles, colors } = useFerrariTemplate();
	...
	const sections = getFerrariSections({ mainSections, sidebarSections, fullWidth: page.fullWidth });
...
const Header = ({ styles }: FerrariHeaderProps) => {
...
const useFerrariTemplate = (): FerrariTemplate => {
	...
	return useMemo(() => {
		...
		return { colors, styles: baseStyles satisfies FerrariStyles };
