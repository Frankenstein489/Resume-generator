// Ported from Reactive Resume (packages/pdf/src/templates/aston/AstonPage.tsx)
...
type AstonStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	picture: Style;
	headerTitle: Style;
...
type AstonHeaderProps = {
	styles: AstonStyles;
};

export const AstonPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useAstonTemplate();
...
const Header = ({ styles }: AstonHeaderProps) => {
...
const useAstonTemplate = (): AstonTemplate => {
