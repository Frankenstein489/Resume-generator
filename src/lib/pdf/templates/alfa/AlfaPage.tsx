// Ported from Reactive Resume (packages/pdf/src/templates/alfa/AlfaPage.tsx)
...
type AlfaStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	headerTitle: Style;
...
type AlfaHeaderProps = {
	styles: AlfaStyles;
};

export const AlfaPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useAlfaTemplate();
...
const Header = ({ styles }: AlfaHeaderProps) => {
...
const useAlfaTemplate = (): AlfaTemplate => {
