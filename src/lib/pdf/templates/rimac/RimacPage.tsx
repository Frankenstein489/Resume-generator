// Ported from Reactive Resume (packages/pdf/src/templates/rimac/RimacPage.tsx)
...
type RimacStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
...
type RimacHeaderProps = {
	styles: RimacStyles;
};

export const RimacPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useRimacTemplate();
...
const Header = ({ styles }: RimacHeaderProps) => {
...
const useRimacTemplate = (): RimacTemplate => {
