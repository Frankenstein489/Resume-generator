// Ported from Reactive Resume (packages/pdf/src/templates/mclaren/MclarenPage.tsx)
...
type MclarenStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	headerBand: Style;
	pictureAnchor: Style;
...
type MclarenTemplate = {
	colors: TemplateColorRoles;
	styles: MclarenStyles;
};

type MclarenHeaderProps = {
	styles: MclarenStyles;
};

export const MclarenPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata, picture } = data;
	const { colors, styles } = useMclarenTemplate();
...
const Header = ({ styles }: MclarenHeaderProps) => {
...
const useMclarenTemplate = (): MclarenTemplate => {
