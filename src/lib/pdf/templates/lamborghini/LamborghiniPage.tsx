// Ported from Reactive Resume (packages/pdf/src/templates/lamborghini/LamborghiniPage.tsx)
...
type LamborghiniStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	mainColumn: Style;
	sidebarColumn: Style;
	header: Style;
...
type LamborghiniTemplate = {
	colors: TemplateColorRoles;
	styles: LamborghiniStyles;
};

type LamborghiniHeaderProps = {
	styles: LamborghiniStyles;
};

export const LamborghiniPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata, picture } = data;
	const { colors, styles } = useLamborghiniTemplate();
...
const Header = ({ styles }: LamborghiniHeaderProps) => {
...
const useLamborghiniTemplate = (): LamborghiniTemplate => {
