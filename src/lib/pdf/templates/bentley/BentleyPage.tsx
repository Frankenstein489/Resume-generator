// Ported from Reactive Resume (packages/pdf/src/templates/bentley/BentleyPage.tsx)
...
type BentleyStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	headerIntro: Style;
	headerBody: Style;
...
type BentleyTemplate = {
	colors: TemplateColorRoles;
	styles: BentleyStyles;
};

type BentleyHeaderProps = {
	styles: BentleyStyles;
};

export const BentleyPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useBentleyTemplate();
...
const Header = ({ styles }: BentleyHeaderProps) => {
...
const useBentleyTemplate = (): BentleyTemplate => {
