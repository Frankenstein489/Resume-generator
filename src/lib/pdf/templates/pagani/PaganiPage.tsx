// Ported from Reactive Resume (packages/pdf/src/templates/pagani/PaganiPage.tsx)
...
type PaganiStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	layout: Style;
...
type PaganiHeaderProps = {
	styles: PaganiStyles;
};

const paganiFeatures = {
	stackSidebarItemHeader: true,
} satisfies TemplateFeatures;

export const PaganiPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = usePaganiTemplate();
	...
	return (
		<Page size={pageSize} style={composeStyles(styles.page, pageMinHeightStyle)}>
			<TemplateProvider styles={styles} colors={colors} features={paganiFeatures}>
...
const Header = ({ styles }: PaganiHeaderProps) => {
...
const usePaganiTemplate = (): PaganiTemplate => {
