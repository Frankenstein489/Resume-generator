// Ported from Reactive Resume (packages/pdf/src/templates/bugatti/BugattiPage.tsx)
...
type BugattiStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	sidebarColumn: Style;
...
type BugattiTemplate = {
	colors: TemplateColorRoles;
	styles: BugattiStyles;
};

type BugattiHeaderProps = {
	styles: BugattiStyles;
	colors: TemplateColorRoles;
};

const bugattiFeatures = {
	stackSidebarItemHeader: true,
	mainItemHeaderBorder: true,
} satisfies TemplateFeatures;

export const BugattiPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useBugattiTemplate();
	...
	return (
		<Page size={pageSize} style={composeStyles(styles.page, pageMinHeightStyle)}>
			<TemplateProvider styles={styles} colors={colors} features={bugattiFeatures}>
				{showSidebar && (
					<View
...
const Header = ({ styles, colors }: BugattiHeaderProps) => {
...
const useBugattiTemplate = (): BugattiTemplate => {
