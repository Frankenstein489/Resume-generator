// Ported from Reactive Resume (packages/pdf/src/templates/jaguar/JaguarPage.tsx)
...
type JaguarStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	layout: Style;
	sidebarColumn: Style;
...
type JaguarHeaderProps = {
	styles: JaguarStyles;
	colors: TemplateColorRoles;
};

const jaguarFeatures = {
	stackSidebarItemHeader: true,
} satisfies TemplateFeatures;

export const JaguarPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata, picture } = data;
	const { colors, styles } = useJaguarTemplate();
	...
	return (
		<Page size={pageSize} style={composeStyles(styles.page, pageMinHeightStyle)}>
			<TemplateProvider styles={styles} colors={colors} features={jaguarFeatures}>
...
const Header = ({ styles, colors }: JaguarHeaderProps) => {
...
const useJaguarTemplate = (): JaguarTemplate => {
