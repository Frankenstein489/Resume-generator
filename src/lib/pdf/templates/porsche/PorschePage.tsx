// Ported from Reactive Resume (packages/pdf/src/templates/porsche/PorschePage.tsx)
...
type PorscheStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	contentRow: Style;
	sidebarColumn: Style;
	mainColumn: Style;
...
type PorscheTemplate = {
	colors: TemplateColorRoles;
	styles: PorscheStyles;
	featureStyles: TemplateFeatureStyleSlots;
};

type PorscheHeaderProps = {
	styles: PorscheStyles;
};
...
export const PorschePage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles, featureStyles } = usePorscheTemplate();
	...
	return (
		<Page size={pageSize} style={composeStyles(styles.page, pageMinHeightStyle)}>
			<TemplateProvider styles={styles} featureStyles={featureStyles} colors={colors} features={porscheFeatures}>
...
const Header = ({ styles }: PorscheHeaderProps) => {
...
const usePorscheTemplate = (): PorscheTemplate => {
