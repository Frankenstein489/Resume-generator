// Ported from Reactive Resume (packages/pdf/src/templates/lotus/LotusPage.tsx)
...
type LotusStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	picture: Style;
	headerTitle: Style;
...
type LotusHeaderProps = {
	styles: LotusStyles;
};

export const LotusPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useLotusTemplate();
...
const Header = ({ styles }: LotusHeaderProps) => {
...
const useLotusTemplate = (): LotusTemplate => {
