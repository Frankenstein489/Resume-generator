// Ported from Reactive Resume (packages/pdf/src/templates/corvette/CorvettePage.tsx)
...
type CorvetteStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	header: Style;
	headerTitle: Style;
...
type CorvetteTemplate = {
	colors: TemplateColorRoles;
	styles: CorvetteStyles;
};

type CorvetteHeaderProps = {
	styles: CorvetteStyles;
};

const corvetteFeatures = {
	inlineItemHeader: true,
} satisfies TemplateFeatures;

export const CorvettePage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useCorvetteTemplate();
	...
	return (
		<Page size={pageSize} style={composeStyles(styles.page, pageMinHeightStyle)}>
			<TemplateProvider styles={styles} colors={colors} features={corvetteFeatures}>
...
const Header = ({ styles }: CorvetteHeaderProps) => {
...
const useCorvetteTemplate = (): CorvetteTemplate => {
